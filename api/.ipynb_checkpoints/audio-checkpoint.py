...
class STTManager:
    ...
    def transcribe_numpy_array(self, audioPath: str, context: Optional[str] = None) -> str:
        """
        ...
        try:
            ...
            if transcribe_method:
                return transcribe_method(audioPath, context)
            else:
...
#         return transcription
    ...
    def _transcribe_hf_api(self, audioPath: str, _context: Optional[str]) -> str:
        """
        Transcribe audio using Hugging Face API.
    ...
    def test_stt(self) -> bool:
        ...
        try:
            import os
            absolute_path = "/root/autodl-tmp/recorded_audio_0.wav"
...
class TTSManager:
    ...
    def _read_text_non_stream(self, headers: dict, data: dict) -> Generator[bytes, None, None]:
        ...
        if self.config.tts.type == "OPENAI_API":
            ...
            # data = {"text": data["text"]}
            # print("function _read_text_non_stream:")
            # print(data)
        else:
